...
public class QuizQuestion extends Activity {
    ...
    public QuizQuestion(QuizQuestion quizQuestion) {
        ...
        this.opta = quizQuestion.getOptA();
        this.optb = quizQuestion.getOptB();
        this.optc = quizQuestion.getOptC();
        this.optd = quizQuestion.getOptD();
        this.answer = quizQuestion.getAnswer();
    }
}
